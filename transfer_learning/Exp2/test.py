...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint', default=r"F:\WorkSpace\py\Experiment\tl\Exp2\DDSPSeg\code\checkpoint\mmwhs\DDSPSeg_20250526_222743_A2B\fold_0")
    parser.add_argument('--load_epoch', type=int, default=500)
    parser.add_argument('--A_root', default="F:\\Dataset\\Medical\\BRAIN\\BIDMC_128")
    parser.add_argument('--B_root', default=r"F:\Dataset\Medical\BRAIN\HK_128")
